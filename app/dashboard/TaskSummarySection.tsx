...
const TaskSummarySection = (): React.JSX.Element => {
        ...
        Modal.confirm({
            ...
            onOk: async () => {
                try {
                    ...
                    // WebSocket "project_deleted" handles UI removal
                } catch (error) {
    ...
    // 6. REST seed — fetch initial data
    useEffect(() => {
        let isMounted = true;
                ...
                client.subscribe("/topic/projects", (msg) => {
                    ...
                    switch (type) {
                        case "project_created":
                            // Fetch full project to ensure members array is populated
